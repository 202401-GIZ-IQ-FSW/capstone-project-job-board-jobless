                    ...
                    <div className="flex flex-wrap justify-center gap-8">
                        <div className="w-full p-6 bg-white rounded-md shadow-md md:w-5/12">
                            <form onSubmit={handleSubmit}>
                                ...
                                <input type="text" id="name" name="name" placeholder="Full name" value={formData.name} onChange={handleChange} required className="w-full p-3 mb-4 border border-gray-300 rounded-md" />

                                <label htmlFor="email" className="block mb-2 font-semibold text-left">Your Email Address</label>
                                <input type="email" id="email" name="email" placeholder="yourname@example.com" value={formData.email} onChange={handleChange} required className="w-full p-3 mb-4 border border-gray-300 rounded-md" />

                                <label htmlFor="subject" className="block mb-2 font-semibold text-left">Subject</label>
                                <input type="text" id="subject" name="subject" placeholder="Enter a Subject" value={formData.subject} onChange={handleChange} required className="w-full p-3 mb-4 border border-gray-300 rounded-md" />

                                <label htmlFor="message" className="block mb-2 font-semibold text-left">Your Message</label>
                                <textarea id="message" name="message" placeholder="Write your message here" rows="5" value={formData.message} onChange={handleChange} required className="w-full p-3 mb-4 border border-gray-300 rounded-md"></textarea>
